-- Ejecutar manualmente en el SQL Editor del proyecto enlazado.
-- No elimina datos: la actualización de asignaciones se hace únicamente vía RPC.
begin;
...
begin
  ...
  -- Un local inactivo puede seguir visible si ya estaba asignado, pero no
  -- puede convertirse en una nueva asignación.
  if exists (
    select 1
